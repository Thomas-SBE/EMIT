...
int main()
{
    ...
    */
    ...
    buff->dtextarea(L"Ceci est un texte de demonstration pour les zones de texte definies et casse par mot a chaque ligne !\0", EMITRect(21, 8, 38, 13), EMITColor(EMIT_COLOR_WHITE, 0, 0), EMIT_TEXT_WORDBREAK);
